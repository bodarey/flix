...
#   it "is a number_to_currency if total_gross is bigger then 40K" do
#     movie = Movie.new(total_gross: 51_000_000.00)
...
#     movie = Movie.new(raiting: rating)
#     movie.valid?
#     expect(movie.errors[:raiting].any?).to eq(false)
#   end
# end
...
#     movie = Movie.new(raiting: rating)
#     movie.valid?
#     expect(movie.errors[:raiting].any?).to eq(true)
#   end
# end
