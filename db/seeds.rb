...
# user =User.create!
# user =User.create! name:'adminn',username: 'adminn', email: 'adminn@exemple.com', password:'secret'
Movie.create!([
  {
    title: "Iron Man",
    raiting: "PG-13",
...
# roger=User.find_by username: 'roger'
# gene=User.find_by username: 'gene'
# elvis=User.find_by username: 'elvis'
# movie.fans << roger
# movie.fans << gene
# movie.fans << elvis
